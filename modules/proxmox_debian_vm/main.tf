...
resource "proxmox_vm_qemu" "debian_vm" {
  ...
  desc             = "This VM is managed by Terraform, cloned from an Cloud-init Debian image, configured with an internal network and supports CPU hotplug/hot unplug and memory hotplug capabilities."
  tags             = var.vm_tags
